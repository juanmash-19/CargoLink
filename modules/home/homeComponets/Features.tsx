        ...
        <section>
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md' id="about-section">
                <div className='text-center mb-14' >
                    <h2 className='text-3xl m-4 lg:text-5xl font-semibold text-black dark:text-white lg:max-w-60% mx-auto'>Get a many of interesting features.</h2>
                </div>
                <div className='grid sm:grid-cols-2 lg:grid-cols-4 gap-y-20 gap-x-5 mt-32'>
                    {/* {FeaturesData.map((items, i) => ( */}
                        <div className='p-8 relative rounded-3xl bg-gradient-to-b from-black/5 to-white dark:from-white/5 dark:to-black' /*key={i}*/>
                            ...
                            <h3 className='text-2xl text-black dark:text-white font-semibold text-center mt-16'>hello world 1</h3>
                            <p className='text-lg font-normal text-black/50 dark:text-white/50 text-center mt-2'>hello world</p>
