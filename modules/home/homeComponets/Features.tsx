        ...
        <section>
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md' id="about-section">
                <div className='text-center mb-14'>
                    <h2 className='text-3xl m-4 lg:text-5xl font-semibold text-black dark:text-white lg:max-w-60% mx-auto'>Empieza con nuestra aplicación...</h2>
                </div>
                <div className='grid justify-center items-center sm:grid-cols-2 lg:grid-cols-4 gap-y-20 gap-x-5 mt-32'>
                    {/* {FeaturesData.map((items, i) => ( */}
                        <div className='p-8 relative rounded-3xl bg-gradient-to-b from-black/5 to-white dark:from-white/5 dark:to-black' /*key={i}*/>
                            ...
                            <h3 className='text-2xl text-black dark:text-white font-semibold text-center mt-16'>Cliente</h3>
